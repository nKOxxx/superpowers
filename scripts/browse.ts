...
program
  ...
  .action(async (url: string, options: { viewport?: string; width?: string; height?: string; flows?: string; screenshot?: boolean; fullPage?: boolean; output?: string; responsive?: boolean; headless?: boolean; waitFor?: string; delay?: string; hide?: string; config?: string }) => {
    try {
