 ...
 */
export function getMarketTemplate(market) {
    return {
        market,
        competitors: [],
        trends: [],
 ...
 */
export function analyzeFeasibility(_featureName, options = {}) {
 ...
 */
export function generateNextSteps(featureName, feasibility) {
    const steps = [];
    // Discovery phase
 ...
 */
export function formatMarketAnalysis(analysis) {
    const lines = [
 ...
 */
export function formatFeasibilityAnalysis(analysis) {
    const lines = ['Feasibility Analysis', '===================='];
    lines.push('');
 ...
 */
export function getMarketInsightsTemplate(feature, market) {
    return `
