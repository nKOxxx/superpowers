...
import { evaluateBAT, formatBATEvaluation, getRecommendationTable, DIMENSION_TITLES, CRITERIA } from './lib/bat-scoring.js';
...
program
    ...
    try {
        ...
        if (options.interactive || !feature) {
            ...
            for (const dimension of ['brand', 'attention', 'trust']) {
