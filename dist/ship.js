...
import { bump, validateBump } from './lib/version.js';
import { generateChangelogEntry, getCommits, updateChangelog, getLastTag } from './lib/changelog.js';
import { getRepoFromGit, parseRepo, isWorkingDirectoryClean, createReleaseCommit, createGitTag, pushCommits, pushTag, createRelease, sendTelegramNotification } from './lib/github.js';
...
program
    ...
    try {
        ...
        // Bump version
        const bumpType = options.version;
        ...
        if (options.dryRun) {
            ...
            const changelogEntry = generateChangelogEntry(versionResult.newVersion, commits, {
                preset: config.ship.changelog.preset,
