...
// Find the skill's dist/index.js
const skillPaths = [
  join(__dirname, '..', 'skills', skillPackage.replace('@superpowers/', ''), 'dist', 'index.js'),
  join(process.cwd(), 'node_modules', skillPackage, 'dist', 'index.js'),
];
