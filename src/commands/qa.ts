...
function findSmokeTests(framework: string): string[] {
  const patterns = [
    '**/*.smoke.test.{ts,js}',
    '**/smoke/**/*.test.{ts,js}',
    '**/tests/smoke/**/*.{ts,js}'
...
function findAllTests(framework: string): string[] {
...
function runTests(testFiles: string[], framework: string, options: QAOptions): TestResult[] {
